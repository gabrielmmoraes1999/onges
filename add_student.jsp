<%-- 
    ...
    Created on : 06/07/2021, 13:20:53
...
<html>
    <head>
        ...
        <title>OnGes - Adicionar Aluno</title>
                    ...
                    <div class="header-body">
                        <div class="row align-items-center py-4">
                            <div class="col-lg-6 col-7">
                                <h6 class="h2 text-white d-inline-block mb-0">Adicionar Aluno</h6>
            ...
            <div class="container-fluid mt--6">
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="create_student" action="./create_student.do" method="post" class="needs-validation" novalidate>
