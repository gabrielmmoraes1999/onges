<%-- 
    Document   : manage_profile_menu
    Created on : 31/03/2021, 21:06:53
                            ...
                            <div class="col-lg-6 col-7">
                                ...
                                <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                    <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Gerenciar Perfil: <%=p.getName() %></li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="col-lg-6 col-5 text-right">
                                <a class="btn btn-sm btn-neutral" href="../admin/ProfileOnges">
                                    Voltar
                                </a>
                            </div>
                        </div>
                            ...
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody class="list">
                                    <%
                                        ...
                                        ProfileDAO pDAO = new ProfileDAO();
                                        try{
                                           list = pDAO.unlinkedMenus(p.getId());
                                        }catch(Exception e){
                                            out.print("Erro:"+e);
                                        }
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="table-action" data-toggle="tooltip" data-original-title="Adicionar" href="../manage_profile_menu.do?id_menu=<%=m.getId() %>&id_profile=<%=p.getId() %>&op=vincular">
                            ...
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody class="list">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="table-action table-action-delete" data-toggle="tooltip" data-original-title="Excluir" href="../manage_profile_menu.do?id_menu=<%=m.getId() %>&id_profile=<%=p.getId() %>&op=remover">
