...
<%
    ...
    try{
        listP = pDAO.profileOnGes();
        list = fDAO.uploadByNoSchool();
        
        for(Funcionary f:list){
            listL.add(lDAO.uploadByUser(f.getUser().getId()));
        }
                    ...
                    <div class="header-body">
                        <div class="row align-items-center py-4">
                            ...
                            <div class="col-lg-6 col-5 text-right">
                                <a href="AddFuncionary" class="btn btn-sm btn-neutral">Novo Funcionário</a>
                            </div>
                        </div>
                    </div>
                </div>
