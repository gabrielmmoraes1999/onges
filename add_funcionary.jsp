<%-- 
    Document   : add_funcionary
    Created on : 29/03/2021, 15:04:37
...
<%
    ...
    ResponsibleSchool rs = rsDAO.uploadByUser(u.getId());
    
    SchoolDAO sDAO = new SchoolDAO();
    School s = sDAO.uploadByResponsibleSchool(rs.getId());
    
    FuncionaryDAO fDAO = new FuncionaryDAO();
    Funcionary f = fDAO.uploadByIdUser(u.getId());
%>
<!DOCTYPE html>
<html>
    <head>
        ...
        <title>OnGes - Novo Funcionário</title>
                    ...
                    <div class="header-body">
                        <div class="row align-items-center py-4">
                            <div class="col-lg-6 col-7">
                                <h6 class="h2 text-white d-inline-block mb-0">Adicionar Funcionário</h6>
            ...
            <div class="container-fluid mt--6">
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="create_funcionary" action="./create_funcionary.do" method="post" class="needs-validation" novalidate>
                                <%
                                    if(rs.getId() != 0){
                                %>
                                <input type="hidden" name="id_school" value="<%=s.getId() %>">
                                <%    
                                    } else if(f.getSchool() != null){
                                %>
                                <input type="hidden" name="id_school" value="<%=f.getSchool().getId() %>">
                                <%    
                                    }else{
                                %>
                                <input type="hidden" name="id_school" value="0">
                                <%
                                    }
                                %>
                                <div class="form-row">
