<%-- 
    ...
    Created on : 24/05/2021, 17:13:29
...
<%
    ...
    int idSchool = Integer.parseInt(request.getParameter("id_school"));
%>
<!DOCTYPE html>
<html>
    <head>
        ...
        <title>OnGes - Adicionar Professor</title>
                    ...
                    <div class="header-body">
                        <div class="row align-items-center py-4">
                            <div class="col-lg-6 col-7">
                                <h6 class="h2 text-white d-inline-block mb-0">Adicionar Professor</h6>
                                <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                    <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                        <li class="breadcrumb-item"><a><i class="fas fa-home"></i></a></li>
                                        <li class="breadcrumb-item"><a>Professores</a></li>
                        ...
                        <div class="card-wrapper">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="mb-0">Adicionar Professor</h3>
                                </div>
                                <div class="card-body">
                                    <form name="create_teacher" action="./create_teacher.do" method="post" class="needs-validation" novalidate>
